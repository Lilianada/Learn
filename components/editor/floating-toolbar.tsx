...
export function FloatingToolbar({ editor, isActive, position, onImageAdd }: FloatingToolbarProps) {
      ...
      if (contentContainer) {
        ...
        if (toolbarRect.right > containerRect.right - 8) {
          ...
          if (toolbarRef.current) {
            toolbarRef.current.style.left = `${parseFloat(toolbarRef.current.style.left) - offset}px`
          }
    ...
    >
        ...
        {/* Headings dropdown */}
            <DropdownMenu>
                ...
                <Button variant="ghost" className="h-10 px-2 flex items-center gap-1">
            ...
            <div className="hidden md:flex gap-0.5">
                ...
                variant="ghost"
                size="icon"
                className={`h-10 w-10 rounded-none ${editor.isActive("bold") ? "bg-muted" : ""}`}
                ...
                variant="ghost"
                size="icon"
                className={`h-10 w-10 rounded-none ${editor.isActive("italic") ? "bg-muted" : ""}`}
                ...
                variant="ghost"
                size="icon"
                className={`h-10 w-10 rounded-none ${editor.isActive("underline") ? "bg-muted" : ""}`}
                ...
                variant="ghost"
                size="icon"
                className={`h-10 w-10 rounded-none ${editor.isActive("strike") ? "bg-muted" : ""}`}
